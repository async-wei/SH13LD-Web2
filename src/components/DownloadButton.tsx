  ...
  return (
    ...
    >
      ...
      <span className="flex items-center justify-center mr-4">
        <Download className="text-cyber-glow group-hover:text-white transition-colors duration-300 group-hover:animate-bounce" size={28} />
      </span>
      
      <span className="font-extrabold text-2xl text-cyber-glow group-hover:text-white transition-colors duration-300 tracking-wide drop-shadow-lg">
        {children}
      </span>
