    ...
    <div className="min-h-screen bg-background text-foreground overflow-x-hidden">
      ...
      <section className="min-h-screen flex items-center justify-center relative px-4">
        <div className="container mx-auto relative" style={{overflow: 'visible'}}>
          <div className="flex flex-col-reverse lg:flex-row items-center justify-between gap-12 lg:gap-24relative" style={{overflow: 'visible'}}>
            {/* Left: Text Content */}
            <div className="w-full lg:w-1/2 flex flex-col items-start justify-center text-left z-10">
              ...
              >
                <span className="cyber-glow-flicker">SH13LD©</span>
              </motion.h1>
              <motion.h2
                initial={{ opacity: 0, y: 20 }}
                animate={{ opacity: 1, y: 0 }}
            ...
            <motion.div
              ...
              className="flex-1 flex items-center justify-center min-h-[28rem]"
            >
        ...
        <div className="container mx-auto px-4 text-center">
          ...
          >
            ...
            <p className="text-xl text-muted-foreground mb-8">
              Join users who trust SH13LD© to protect their privacy and enhance their system security.
            </p>
      ...
      <section id="downloads" className="py-36 pb-5 relative mt-20">
        <div className="container mx-auto px-4 flex flex-col items-center justify-center">
          ...
          <div className="w-full flex flex-col items-center max-w-xl mx-auto space-y-4">
            <DownloadButton href="public\[SH13LD SETUP EXE]">
              Download SH13LD v1 (x64)
            </DownloadButton>
            
            <DownloadButton href="public\[SH13LD SETUP arm64 EXE]">
              Download SH13LD v1 (arm64)
            </DownloadButton>
            
            <DownloadButton href="public\[SH13LD SETUP ia32 EXE]">
              Download SH13LD v1 (ia32)
            </DownloadButton>
          </div>
        </div>
      </section>
      ...
      <footer className="py-16 border-t border-border relative mt-[10rem]">
        <div className="container mx-auto px-10">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div>
              <h3 className="text-lg font-semibold mb-4 text-foreground">SH13LD©</h3>
            ...
            <div>
              ...
              <div className="flex gap-4">
                <Button variant="ghost" size="sm">
                  <a href="https://github.com/mi-lrn/SH13LD" target="_blank" rel="noopener noreferrer" className="transition-colors duration-200 rounded-full hover:bg-[#29abe0]/90">
                    <Github size={16} />
                  </a>
                </Button>
          ...
          <div className="mt-8 pt-8 border-t border-border text-center text-muted-foreground text-sm">
            © 2025 SHi3LD©. All rights reserved.
          </div>
        </div>
      </footer>
    </div>
